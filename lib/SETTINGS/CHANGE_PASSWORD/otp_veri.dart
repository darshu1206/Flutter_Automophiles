...
import 'package:flutter_splash_login_signup/SETTINGS/CHANGE_PASSWORD/reset_pass.dart';
...
class _MyAppState extends State<OTP2> {
                        ...
                        child: MaterialButton(
                          ...
                          onPressed: (){
                            Navigator.pushReplacement(context, MaterialPageRoute(
                                builder: (context) => ResetPassScreen2()
                            ));
